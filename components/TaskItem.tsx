    ...
    <div 
      ...
      className={`
        ...
        ${selected 
            ...
            : 'bg-surface-card_light dark:bg-surface-card_dark shadow-soft-sm dark:shadow-soft-dark-sm hover:-translate-y-1 hover:shadow-soft dark:hover:shadow-soft-dark'
        }
